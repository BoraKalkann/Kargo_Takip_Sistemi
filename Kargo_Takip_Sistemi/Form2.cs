...
namespace Kargo_Takip_Sistemi
{
    public partial class Form2 : Form
    {
        ...
        {
            cmbNereden.Items.AddRange(new string[] { "İstanbul", "Ankara", "İzmir", "Bursa", "Mersin", "Malatya", "Elazığ", "Kahramanmaraş" });
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            string bilgi = $"F2:Kargo takip numarası: {takipNo} || İsim Soyisim: {isimSoyisim} ||Telefon: {telefonNumarasi} || TC: {tcKimlikNo} || Adres: {adres} || Rota: {nereden} → {nereye} || Kırılacak mı: {kirilacakMi}, Durumu: {durum}";
